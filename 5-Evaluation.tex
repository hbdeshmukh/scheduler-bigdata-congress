...
The skew is introduced in the \textit{lo\_quantity} column of \textit{lineorder} table, as described by Rabl et al.~\cite{DBLP:conf/wosp/RablPJOO13}.
...
specification of HPF (Highest Priority First, cf. Table~\ref{table:policy-interpreatations}) policy.
...
Due to space restriction, we present the evaluation of Proportional Priority policy in~\cite{supplement}.
