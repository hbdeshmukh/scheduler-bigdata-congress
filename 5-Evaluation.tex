...
the policy behavior. 
\item To illustrate the role of the learning component, we compare it with policy implementations that don't use the learning-based feedback loop. 
The probability assigned to each query in this implementation is \textit{fixed} and \textit{statically determined}.
