...
To test the scheduler's ability to learn in the presence of skew, we compare the predicted work order times for each query with the observed work order times for the same query.
