...
In this experiment, we examine the load control capabilities of \sys{}'s scheduler.
We use two queries from each SSB query class.
The queries from each query class have been assigned a priority value, that reflects the complexity of the queries from the class (e.g. number of joins in the query plan).
