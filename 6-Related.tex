...
Such solutions include features %such as admission control capabilities, 
classification of queries based on their estimated resource requirements % (e.g. CPU, memory, I/O), 
