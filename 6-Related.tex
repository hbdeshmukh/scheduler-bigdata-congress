...
Prior research~\cite{wu2013towards, wu2014uncertainty, duggan2011performance} has developed analytical model based on the optimizer's cost models for both single query and multiple concurrent queries.
